...
from domain.fizz_buzz_revisited.fizz_buzz_revisited import replace_if_contains_integer, replace_if_contains_multiple_of
from domain.fizz_buzz_revisited.fizz_buzz_tools_revisited import a_returning_a_list_of_integers, is_multiple_of


class TestFizzBuzz(unittest.TestCase):
    def test_contains_a_three_and_replace_for_a_Fizz(self):
        self.assertEqual([1,2,"fizz"], replace_if_contains_integer(1, 4))

    def test_contains_a_five_and_replace_for_a_buzz(self):
        self.assertEqual([4,"buzz"], replace_if_contains_integer(4, 6))

    def test_contains_an_integer(self):
        self.assertEqual([1, 2, "fizz", 4, "buzz"], replace_if_contains_integer(1, 6))
    ...
    def test_replacing_multiple_of_three_for_fizz(self):
        self.assertEqual([1, 2, "fizz"], replace_if_contains_multiple_of(1, 4))

    def test_replacing_multiple_of_five_for_buzz(self):
        self.assertEqual([4, "buzz"], replace_if_contains_multiple_of(4, 6))

    def test_replacing_multiple_of_three_for_bizz_and_five_for_buzz(self):
        self.assertEqual([1, 2, "fizz", 4, "buzz"], replace_if_contains_multiple_of(start=1, end=6))

    def test_replacing_multiples_of_three_and_five_adding_words_fizz_buzz(self):
        self.assertEqual(["buzz", 11, "fizz", 13, 14, "fizzbuzz"], replace_if_contains_multiple_of(10, 16))
